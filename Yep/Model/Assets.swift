...
extension Assets {
    ...
    func imageKeyCode() -> String {
        return """
        \(fileComments(title: "ImageKey", target: nil))
        \(imagesTree.generateCode(indentation: "", target: .uiKit, isSPM: true, separator: "/", keyOnly: true))
        """
    }

    func colorKeyCode() -> String {
        return """
        \(fileComments(title: "ColorKey", target: nil))
        \(colorsTree.generateCode(indentation: "", target: .uiKit, isSPM: true, separator: "/", keyOnly: true))
        """
    }
}
